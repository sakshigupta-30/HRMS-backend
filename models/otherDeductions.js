...
const OtherDeductionsSchema = new mongoose.Schema(
  {
...
OtherDeductionsSchema.index({ worker: 1, year: 1, month: 1 }, { unique: true });

module.exports = mongoose.model("OtherDeductions", OtherDeductionsSchema);